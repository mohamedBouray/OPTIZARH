                                    ...
                                    <div className={`p-5 rounded-xl ${cardClass} border ${borderClass} space-y-4`}>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="ex: prenom.nom@entreprise.com" className={`w-full p-2.5 rounded-lg border bg-transparent ${borderClass} ${textClass} transition-all`} required />
                                            </div>
                                            <div>
                                                <label className={`block text-xs mb-1 ${textMutedClass}`}>Mot de passe</label>
                                                <div className="relative">
